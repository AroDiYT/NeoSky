...
module.exports = function (messageObject) {
  ...
  } else if (messageObject.sender && messageObject.sender.id && messageObject.message && messageObject.message && messageObject.message.attachments) {
    return {
      sender: messageObject.sender.id,
      originalRequest: messageObject,
      attachments: messageObject.message.attachments.map(attachment => {
        return {
